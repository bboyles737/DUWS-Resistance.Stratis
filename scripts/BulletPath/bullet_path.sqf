/* Bullet trajectory script
   By Hypnomatic
   Bullet velocity coloring added by Dslyexci   
*/
...
Params:
    ...
    _trackVel:    If true, _color is overriden by the a color indicative of velocity at that moment.  Thanks to Dslyecxi for this parameter! (Default true)
Return Value:
...
hyp_fnc_traceFire = {
    ...
    _trackVel    = [_this, 6, true, [true]] call BIS_fnc_param;
