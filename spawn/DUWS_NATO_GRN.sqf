Spawn_NATO_GRN = {
// Spawns a NATO, US Army Team Grenadier
...
_this = _grp createUnit ["B_Soldier_GL_F", _pos, [], 5, "PRIVATE"];
...
for "_i" from 1 to 12 do {_this addItemToVest "1Rnd_HE_Grenade_shell";};
